...
const FOOD_EMOJI_CATEGORIES = [
    ...
    },
    {
        ...
        icon: "🍩",
        items: [
            { emoji: "🍦", name: "Ice Cream", searchOn: "Ice Cream" },
            { emoji: "🍧", name: "Shaved Ice", searchOn: "Shaved Ice" },
            { emoji: "🍨", name: "Hard Ice Cream", searchOn: "Hard Ice Cream" },
            { emoji: "🍩", name: "Doughnut", searchOn: "Doughnut" },
            { emoji: "🍪", name: "Cookie", searchOn: "Cookie" },
            { emoji: "🎂", name: "Cake", searchOn: "Cake" },
            { emoji: "🍰", name: "Cheesecake", searchOn: "Cheesecake" },
            { emoji: "🧁", name: "Cupcake", searchOn: "Cupcake" },
            { emoji: "🥧", name: "Pie", searchOn: "Pie" },
            { emoji: "🍫", name: "Chocolate Bar", searchOn: "Chocolate Bar" },
            { emoji: "🍬", name: "Hard Candy", searchOn: "Hard Candy" },
            { emoji: "🍭", name: "Lollipop", searchOn: "Lollipop" },
